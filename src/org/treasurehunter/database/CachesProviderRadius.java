...
public class CachesProviderRadius implements ICachesProviderCenter {
    ...
    private void updateBounds() {
        ...
        /*
         * double lat_radians = Math.toRadians(mLatitude); double cos_lat =
         * Math.cos(lat_radians); double lonLow = Math.max(-180, mLongitude -
         * mDegrees / cos_lat); double lonHigh = Math.min(180, mLongitude +
         * mDegrees / cos_lat);
         */
