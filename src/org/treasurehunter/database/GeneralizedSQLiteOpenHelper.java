...
/**
 * This is an adaptation of the Android 1.5 SQLiteOpenHelper class. It differs
 * in taking a full path to the database, meaning that the database can be
 * located anywhere and not only under the application's data area in the
 * internal storage.
 */
public abstract class GeneralizedSQLiteOpenHelper {
    private static final String TAG = "TreasureHunter";
     ...
     */
    public GeneralizedSQLiteOpenHelper(String path, CursorFactory factory, int version) {
        if (version < 1)
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {
        ...
        // CAN'T DO THIS SINCE lock() IS PACKAGE PRIVATE
        ...
        try {
            ...
            if (mPath == null) {
                ...
                db = SQLiteDatabase.openOrCreateDatabase(mPath, null);
            }
    ...
    public synchronized SQLiteDatabase getReadableDatabase() {
        ...
        try {
            mIsInitializing = true;
            db = SQLiteDatabase.openDatabase(mPath, mFactory, SQLiteDatabase.OPEN_READONLY);
