...
/**
 * An ordered list of geocache objects, with support for comparing with another
 * such list. A future implementation can fetch the geocaches from the database
 * when first needed
 */
public class GeocacheListPrecomputed extends GeocacheList {
    private final ArrayList<Geocache> mList;

    public static GeocacheListPrecomputed EMPTY = new GeocacheListPrecomputed();
