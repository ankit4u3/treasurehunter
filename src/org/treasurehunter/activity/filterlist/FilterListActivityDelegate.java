...
public class FilterListActivityDelegate {
    ...
    private static class FilterListAdapter extends BaseAdapter {
        ...
        public FilterListAdapter(Context context, FilterTypeCollection filterTypeCollection) {
            ...
            mIconSelected = BitmapFactory.decodeResource(resources, R.drawable.btn_radio_on);
            // android.R.drawable.radiobutton_on_background);
            mIconUnselected = BitmapFactory.decodeResource(resources, R.drawable.btn_radio_off);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        GeocacheFilter cacheFilter = mFilterTypeCollection.get(position);
