...
public class FileLogger implements ICacheLogger {
    ...
    public FileLogger(FieldnoteStringsFVsDnf fieldnoteStringsFVsDnf, DateFormat simpleDateFormat,
    ...
    public void log(CharSequence geocacheId, CharSequence logText, boolean dnf) {
        try {
            ...
            final String logLine = String.format("%1$s,%2$s,%3$s,\"%4$s\"\n", geocacheId,
                    formattedDate,
                    mFieldnoteStringsFVsDnf.getString(R.array.fieldnote_file_code, dnf),
                    logText.toString());
