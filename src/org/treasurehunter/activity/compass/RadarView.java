...
public class RadarView extends View {
     ...
     */
    public void setDistanceView(TextView d, TextView b, TextView a, TextView lag) {
        mDistanceView = d;
        mBearingView = b;
        mAccuracyView = a;
        mLagView = lag;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mHaveLocation) {
            ...
            Log.d("TreasureHunter", "Target In position for Questiond");
            ...
            mArrowPath.moveTo(center + (float)Math.cos(arrowRight) * radius,
                    center + (float)Math.sin(arrowRight) * radius);
            mArrowPath.lineTo(center + cos * radius, center + sin * radius);
            mArrowPath.lineTo(center + (float)Math.cos(arrowLeft) * radius,
                    center + (float)Math.sin(arrowLeft) * radius);
    ...
    public void setLocation(GeoFix location, float azimuth) {
        // Log.d("TreasureHunter", "radarview::onLocationChanged");
        mHaveLocation = true;
