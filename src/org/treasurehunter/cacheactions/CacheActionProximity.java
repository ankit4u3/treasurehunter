...
import org.treasurehunter.activity.prox.ProximityActivity;

import android.app.Activity;
import android.content.Intent;
import android.content.res.Resources;

public class CacheActionProximity extends StaticLabelCache implements CacheAction {
    ...
    public void act(Geocache cache, Waypoint waypoint) {
        final Intent intent = new Intent(mActivity, ProximityActivity.class);
        intent.putExtra(Geocache.ID, cache.getId());
