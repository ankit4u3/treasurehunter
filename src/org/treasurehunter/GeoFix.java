...
/**
 * Wrapper for the class android.location.Location that can't be instantiated
 * directly
 */
public class GeoFix {
    ...
    /** When this GeoFix was acquired, in millisec */
    ...
    public GeoFix(float accuracy, double altitude, double latitude, double longitude, long time,
            String provider) {
        mAccuracy = 10;
        mAltitude = altitude;
        mLatitude = latitude;
    ...
    public float distanceTo(GeoFix fix) {
        ...
        Location.distanceBetween(mLatitude, mLongitude, fix.getLatitude(), fix.getLongitude(),
                results);
        return results[0];
    }
