...
public class MenuActionConfirm implements MenuAction {
    ...
    public MenuActionConfirm(Activity activity, AlertDialog.Builder builder, MenuAction menuAction,
    ...
    private AlertDialog buildAlertDialog() {
        ...
        mBuilder.setMessage(mBody).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
